...
const Advergames = () => {
    return (
        <Panel>
            ...
            <div className="mt-2">
                Gli advergames <i>(advertising/videogame)</i> sono videogiochi a scopo di marketing: un metodo potente e innovativo per catturare l&apos;<span className="text-pink-500"><i>attenzione</i></span> degli utenti e guidarli alla scoperta del tuo <span className="text-pink-500"><i>brand</i></span>.
            </div>
            <div>
