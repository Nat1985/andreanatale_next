        ...
        <Panel isBlack={isBlack}>
            ...
            <div className="flex flex-col gap-8 md:text-start">
                <div className="flex flex-col md:flex-row gap-2 items-center">
                    ...
                    <div className="">Ad ogni lavoro che eseguo, previa analisi delle esigenze e della situazione del cliente, offro <b>servizi opzionali</b> che possano aggiungere valore alla sua richiesta.</div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-2 items-center">
                    ...
                    <div className="">Offro la mia consulenza sempre <b>gratuitamente</b>, cercando di evitare di vendere a tutti i costi un prodotto, se sono consapevole che esso non offrirebbe il valore di cui il cliente ha bisogno. Cerco piuttosto di capire a fondo se le mie competenze (e idee) possano davvero soddisfarlo.</div>
                </div>
